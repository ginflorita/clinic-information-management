<x-app-layout>
    <x-slot name="header">
        <h2 class="fs-4 fw-semibold text-dark mb-0">Inventory Units</h2>
    </x-slot>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="bg-white shadow-sm rounded p-4">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('admin.inventory-units.create') }}" class="btn btn-primary">New Unit</a>
                </div>
                    ...
                    <tbody>
                        @foreach ($inventoryUnits as $unit)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('admin.inventory-units.edit', $unit) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
